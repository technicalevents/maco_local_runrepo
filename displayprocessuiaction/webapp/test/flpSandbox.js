						...
						"inbounds": {
							"UtilsDataExchangeProcessing-processUiAction": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.cd.maco.monitor.ui.app.processuiaction",
									"url": sap.ui.require.toUrl("com/sap/cd/maco/monitor/ui/app/processuiaction")
								}
							}
						}
					}
