sap.ui.define(
  ['com/sap/cd/maco/mmt/ui/reuse/fnd/base/NoDraftComponent', 'sap/ui/model/json/JSONModel', 'com/sap/cd/maco/mmt/ui/reuse/mmt/valueHelpValues'],
  function(NoDraftComponent, JSONModel, valueHelpValues) {
    'use strict';

    return NoDraftComponent.extend('com.sap.cd.maco.mmt.ui.reuse.mmt.MmtComponent', {
      init: function() {
