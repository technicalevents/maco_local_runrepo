...
sap.ui.define(
  ...
  function(Object, UI5MetadataTool, Dialog, Text, Button, Icon, HBox, VBox) {
    'use strict';

    return Object.extend('com.sap.cd.maco.mmt.ui.reuse.base.Assert', {
      ...
      instance: function(oObject, sClassName, sMessage) {
        if (!this._oUI5MetadataTool.isInstance(oObject, sClassName)) {
          var oError = new Error(sMessage);
          this._showAndLog(oError);
          throw oError;
        }
      ...
      subclass: function(oObject, sClassName, sMessage) {
        if (!this._oUI5MetadataTool.isSubclass(oObject, sClassName)) {
          var oError = new Error(sMessage);
          this._showAndLog(oError);
          throw oError;
        }
