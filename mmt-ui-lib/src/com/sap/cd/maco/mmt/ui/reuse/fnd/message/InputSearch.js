sap.ui.define(['com/sap/cd/maco/mmt/ui/reuse/fnd/message/ControlSearch'], function(ControlSearch) {
  'use strict';

  return ControlSearch.extend('com.sap.cd.maco.mmt.ui.reuse.message.InputSearch', {
