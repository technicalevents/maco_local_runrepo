...
sap.ui.define(
  [
    ...
    'com/sap/cd/maco/mmt/ui/reuse/share/SaveAsTileAction',
    'com/sap/cd/maco/mmt/ui/reuse/share/SendEmailAction'
  ],
  function(BaseAction, SaveAsTileAction, SendEmailAction) {
    'use strict';

    return BaseAction.extend('com.sap.cd.maco.mmt.ui.reuse.share.ShareAction', {
      ...
      execute: function(oParams) {
        return new Promise(
          function(resolve, reject) {
            ...
            // lazy create menu
            if (!this._oMenu) {
              this._oMenu = sap.ui.xmlfragment('com.sap.cd.maco.mmt.ui.reuse.share.ShareActionMenu', this);
            }
