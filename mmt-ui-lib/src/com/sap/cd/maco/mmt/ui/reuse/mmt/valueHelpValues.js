sap.ui.define([], function() {
  ...
  return {
    ...
    AuthforRevEmail: [{ id: '01', text: 'Plain User/Password' }, { id: '02', text: 'Encrypted User/Password' }],
    AuthforSendEmail: [{ id: '01', text: 'None' }, { id: '02', text: 'Plain User/Password' }, { id: '03', text: 'Encrypted User/Password' }]
  };
});
