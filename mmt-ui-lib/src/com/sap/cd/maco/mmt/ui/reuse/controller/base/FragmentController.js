/*global location*/
sap.ui.define(
  ['sap/ui/base/Object', 'sap/ui/core/Fragment', 'com/sap/cd/maco/mmt/ui/reuse/fnd/ContentDensity', 'com/sap/cd/maco/mmt/ui/reuse/fnd/Assert'],
  function(Object, Fragment, ContentDensity, Assert) {
    'use strict';

    return Object.extend('com.sap.cd.maco.mmt.ui.reuse.controller.base.FragmentController', {
      ...
      constructor: function(params) {
        // check params
        Assert.ok(params, 'Cannot instantiate FragmentController. params missing');
        Assert.ok(params.component, 'Cannot instantiate FragmentController. component missing');
        Assert.ok(params.id, 'Cannot instantiate FragmentController. id missing');
        Assert.ok(params.fragmentName, 'Cannot instantiate FragmentController. fragmentName missing');
        // optional: view
