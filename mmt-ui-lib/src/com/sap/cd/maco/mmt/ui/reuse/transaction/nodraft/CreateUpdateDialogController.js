...
sap.ui.define(
  [
    ...
    'com/sap/cd/maco/mmt/ui/reuse/base/BaseFragmentController',
  ...
  function(JSONModel, BaseFragmentController, bundle, CallWithMessageHandling, getConfigText) {
    'use strict';

    return BaseFragmentController.extend('com.sap.cd.maco.mmt.ui.reuse.transaction.nodraft.CreateUpdateDialogController', {
      //~~~~ init ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      constructor: function(oConfig) {
        ...
        this.oAssert.ok(oConfig.entitySet, 'cannot init CreateUpdateDialogController. no entitySet');
      ...
      onInit: function() {
        ...
        var oViewModel = new JSONModel({
          title: null,
          saveButtonText: null,
          cancelButtonText: bundle.get().getText('buttonCancel')
        });
      ...
      openForCreate: function(oProperties) {
        ...
        oViewModel.setProperty('/saveButtonText', bundle.get().getText('buttonCreate'));
      ...
      openForUpdate: function(sPath) {
        ...
        var oViewModel = this.getThisModel();
        oViewModel.setProperty('/title', sTitle);
        oViewModel.setProperty('/saveButtonText', bundle.get().getText('buttonSave'));
