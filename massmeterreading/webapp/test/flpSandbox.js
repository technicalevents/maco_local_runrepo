						...
						"inbounds": {
							"UtilsDataExchangeProcessing-massMeterReading": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.cd.maco.monitor.ui.app.massmeterreading",
									"url": sap.ui.require.toUrl("com/sap/cd/maco/monitor/ui/app/massmeterreading")
								}
							}
						}
					}
