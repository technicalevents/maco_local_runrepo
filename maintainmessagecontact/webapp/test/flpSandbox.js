						...
						"inbounds": {
							"UtilsDataExchangeProcessing-maintMsgContact": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.cd.maco.selfservice.ui.app.maintmsgcontact",
									"url": sap.ui.require.toUrl("com/sap/cd/maco/selfservice/ui/app/maintmsgcontact")
								}
							}
						}
					}
