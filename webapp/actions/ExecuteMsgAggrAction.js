      ...
      "com.sap.cd.maco.monitor.ui.app.displayprocesses.actions.ExecuteMsgAggrAction",
      {
          ...
          return new Promise(
            function(resolve, reject) {
              ...
              if (!this._oExecuteMsgAggrActionSheet) {
                ...
                oParams.busyControl.addDependent(
                  this._oExecuteMsgAggrActionSheet
                );
              }
              this._oExecuteMsgAggrActionSheet.openBy(
                oParams.event.getSource()
              );
        ...
        onExecuteMsgAggrItemSelected: function(oEvent) {
          ...
          var oData = {
            ...
            Action:
              Constants.PROCESS_LIST_HEADER_ACTION.EXECUTE_MESSAGE_AGGREGATION,
          ...
          this.oTransaction
            ...
            .then(
              function(oResponse) {
                MessageToast.show(
                  JSON.parse(oResponse.response.headers["sap-message"]).message
                );
              }.bind(this)
            );
        }
