sap.ui.define([
	"sap/ui/test/Opa5",
	"com/sap/cd/maco/monitor/ui/app/displayprocess/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel",
	"sap/ui/core/routing/HashChanger",
	"com/sap/cd/maco/monitor/ui/app/displayprocess/test/flpSandbox",
	"sap/ui/fl/FakeLrepConnectorLocalStorage"
], function(Opa5, mockserver, ODataModel, HashChanger, flpSandbox, FakeLrepConnectorLocalStorage) {
	"use strict";

	return Opa5.extend("com.sap.cd.maco.monitor.ui.app.displayprocess.test.integration.arrangements.Startup", {
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "xMP4GxC_ProcessHeader_UI/" + encodeURIComponent(sObjectId);
