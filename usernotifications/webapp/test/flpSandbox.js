						...
						"inbounds": {
							"UtilsDataExchangeProcessing-userNotification": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.cd.maco.selfservice.ui.app.usernotification",
									"url": sap.ui.require.toUrl("com/sap/cd/maco/selfservice/ui/app/usernotification")
								}
							}
						}
					}
