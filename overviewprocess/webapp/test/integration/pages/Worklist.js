		...
		onTheWorklistPage : {
					...
					return this.waitFor(createWaitForItemAtPosition({
						...
						success : function (oTableItem) {
							...
							this.getContext().currentItem = {
								...
								id: oBindingContext.getProperty("ProcessDocumentKey"),
								name: oBindingContext.getProperty("ProcessDocumentNumber")
							};
						}
					}));
				},
			...
			assertions: Object.assign({
				...
				theTableShouldHaveAllEntries : function () {
					...
					// retrieve all xMP4GxC_ProcessHeader_UI to be able to check for the total amount
