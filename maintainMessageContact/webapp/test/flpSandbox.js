						...
						"inbounds": {
							"UtilsDataExchangeProcessing-maintMsgContact": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.cd.maco.monitor.ui.app.maintMsgContact",
									"url": sap.ui.require.toUrl("com/sap/cd/maco/monitor/ui/app/maintMsgContact")
								}
							}
						}
					}
